...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "stashkiv.redis.cache.windows.net";
    private final static String CACHE_KEY = "8Otl0yVcN+nT9NkuPbsa+P+d1KpUEe4qECbrMEEEJj8=";
