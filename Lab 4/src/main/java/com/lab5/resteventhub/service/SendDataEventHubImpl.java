...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("eventhublabiot")//namespace
                .setEventHubName("eventhublabiot")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://eventhublabiot.servicebus.windows.net/;SharedAccessKeyName=policy;SharedAccessKey=Izv/dLEo4+BtKR/fHFQRNnCRYIaRicS2CEnaUBxIU8Q=;EntityPath=eventhublabiot")
                /*Primary key*/
                .setSasKey("Izv/dLEo4+BtKR/fHFQRNnCRYIaRicS2CEnaUBxIU8Q=");
