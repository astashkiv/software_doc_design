...
import { DoctorCertificateComponent } from 'app/entities/doctor-certificate/doctor-certificate.component';
...
describe('Component Tests', () => {
  describe('DoctorCertificate Management Component', () => {
    let comp: DoctorCertificateComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DoctorCertificateComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new DoctorCertificate(123)],
            headers
          })
        )
      );
      ...
      expect(comp.doctorCertificates && comp.doctorCertificates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
